...
public class MembershipBooleanSearch
{
		  ...
		  ExcelApiTest3 eat = new ExcelApiTest3();
			 int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Membership.xls","Sheet1");
				 ...
				 {		 
					 UserName="ADMIN";
					 Password="admin123";
					 Membership=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Membership.xls","Sheet1",i,3);
	...
	{  
	    ...
	    WebElement ele=driver.findElement(By.xpath(OR.Admin_focus));
		 ...
		 driver.findElement(By.xpath(OR.AA_Qualification_Focus1)).click();
		 TH3.HTMLScreenShot("Qualification focus highlight","Qualification focused Succefully ","Pass", HtmlOutputFileName,driver);
		 
		 driver.findElement(By.xpath(OR.Membership_Focus)).click();
		 TH3.HTMLScreenShot("Membership","Membership clicked Succefully ","Pass", HtmlOutputFileName,driver);
		 
		 List  columns = driver.findElements(By.xpath(OR.Membership_Coloms_Click)); 
	    
	     List  rows = driver.findElements(By.xpath(OR.Membership_Rows_Click)); 
	           ...
	           for ( int i=1 ; i<=rows.size() ;i++)
	  		      {
	  				 ...
	  				 driver.findElement(By.xpath(OR.Membership_Delete)).click();
	  				 TH3.HTMLScreenShot("Delte clicked","Membership deleted Succefully ","Pass", HtmlOutputFileName,driver);
	  			
	  				driver.findElement(By.xpath(OR.Membership_Delete_Confirmation)).click();
